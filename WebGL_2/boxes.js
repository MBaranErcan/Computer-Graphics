...
function render() {
   ...
   var orthoNear = 1.0;
   var orthoFar = 100.0;  
   p = ortho(orthoLeft, orthoRight, orthoBottom, orthoTop, orthoNear, orthoFar);
   gl.uniformMatrix4fv(projLoc, gl.FALSE, flatten(transpose(p)));
...
//   mv = mult(mv, rotate(90, 1, 0, 0)); // Rotate 90degrees around x-axis
//   mv = mult(mv, translate(1, 0, 0));  // Translate to (1, 0, 0)
   mv = mult(mv, rotate(30, 1, 0, 0));    // Rotate 30degrees around x-axis
   mv = mult(mv, rotate(30, 0, 1, 0));    // Rotate 30degrees around y-axis
   mv = mult(mv, translate(1, 0, 0));  // Translate to (1, 0, 0)
